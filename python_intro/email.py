...
email = {
    ...
    "to": "  x@qa.COM  ",
    "body": ("Hi! We would like to discuss test-cases for integration testing."
...
corporate_domains = list(set(["company.ru", "corporation.com", "university.edu", "organization.org", "company.ru",
                     "business.net"]))
