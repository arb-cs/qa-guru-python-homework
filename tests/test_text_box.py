...
@allure.feature("Fill the Text Box form.")
@allure.severity(allure.severity_level.BLOCKER)
@allure.description("This test attempts to fill out the text box form.")
def test_fill_text_box(text_box_page: TextBoxPage):
    text_box_page.open()
    text_box_page.fill_fullname("John Doe")
    text_box_page.fill_email("john_doe@gmail.com")
    text_box_page.fill_current_address("740 Route 202 Middletown, NY 10940")
    text_box_page.fill_permanent_address("9476 Virginia Avenue South Richmond Hill, NY 11419")
    ...
    assert result["Permananet Address"] == "9476 Virginia Avenue South Richmond Hill, NY 11419"


@pytest.mark.regression
@allure.feature("Fill the Text Box form.")
@allure.severity(allure.severity_level.CRITICAL)
@allure.description("This test checks that the result box is not displayed when a user enters an invalid email.")
...
@allure.feature("Fill the Text Box form.")
@allure.severity(allure.severity_level.CRITICAL)
@allure.description("This test checks that it is not possible to carry out an SQL injection on the form.")
def test_sql_inject_username_field(text_box_page: TextBoxPage):
    text_box_page.open()
    text_box_page.fill_fullname("'1' OR '1'='1")
    text_box_page.fill_email("john_doe@gmail.com")
    text_box_page.fill_current_address("740 Route 202 Middletown, NY 10940")
    text_box_page.fill_permanent_address("9476 Virginia Avenue South Richmond Hill, NY 11419")
    text_box_page.click_submit_button()
