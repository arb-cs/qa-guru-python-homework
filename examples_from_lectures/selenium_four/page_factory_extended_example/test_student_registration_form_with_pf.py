...
class BasePage(PageFactory):
    ...
    def __init__(self, driver):
        self.driver = driver
        self.timeout = (
            10  # Явное ожидание (Explicit Wait) по умолчанию для PageFactory
        )
...
class AutomationPracticeFormPage(BasePage):
    ...
    def fill_address_and_location(self, address: str, state: str, city: str):
        ...
        self.driver.execute_script(
            "arguments[0].scrollIntoView(true);", self.state_dropdown
        )
...
def test_student_registration_form_max_capabilities(driver):
    ...
    try:
        ...
        assert (
            actual_results.get("Address")
            == "123 University Avenue, Tomsk, Russia"
        )
